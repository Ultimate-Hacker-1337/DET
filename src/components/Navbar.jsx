...
// //           />
// //           <h1 className="text-xl font-bold text-[#5a3825]">دار الایمان والتقویٰ</h1>
// //         </Link>

// //         {/* Nav Section */}
// //         <nav className="flex items-center gap-8 text-md font-medium text-[#4a2f1b]">
// //           {navItems.map((item, i) => (
...
// //               {/* Dropdown */}
// //               {item.sub && (
// //                 <div className="absolute top-full right-0 mt-2 bg-[#fdf6f0] shadow-lg rounded-xl py-2 w-44 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-200 z-50">
