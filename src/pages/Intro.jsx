  ...
  return (
    <div className="bg-[#fefce8] text-[#1e293b]">
      ...
      >
        {/* Vision Card */}
        <motion.div
          className="relative bg-white rounded-3xl shadow-lg border border-emerald-100 p-10 text-center overflow-hidden transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-2"
          variants={cardVariants}
          initial="hidden"
          animate={inView ? "visible" : "hidden"}
          whileHover="hover"
        >
          <div className="absolute inset-0 bg-gradient-to-r from-emerald-50 to-emerald-100 opacity-0 hover:opacity-100 transition-opacity duration-300" />
          <motion.div variants={iconVariants}>
            <Eye className="w-14 h-14 mx-auto text-emerald-600 mb-6" />
          </motion.div>
        ...
        {/* Mission Card */}
        <motion.div
          className="relative bg-white rounded-3xl shadow-lg border border-indigo-100 p-10 text-center overflow-hidden transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-2"
          variants={cardVariants}
          initial="hidden"
          animate={inView ? "visible" : "hidden"}
          whileHover="hover"
        >
          <div className="absolute inset-0 bg-gradient-to-r from-indigo-50 to-indigo-100 opacity-0 hover:opacity-100 transition-opacity duration-300" />
          <motion.div variants={iconVariants}>
            <Target className="w-14 h-14 mx-auto text-indigo-600 mb-6" />
          </motion.div>
          <h3 className="text-3xl font-bold mb-4 text-slate-800 tracking-tight">
            ہمارا مشن
          </h3>
